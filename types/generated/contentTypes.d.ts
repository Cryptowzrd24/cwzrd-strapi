...
export interface ApiTechnicalTechnical extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    analysisDate: Schema.Attribute.DateTime;
    assetType: Schema.Attribute.Enumeration<['crypto', 'forex', 'stock']>;
    author: Schema.Attribute.Relation<'manyToOne', 'api::author.author'>;
    body: Schema.Attribute.Blocks;
    chartEmbed: Schema.Attribute.String;
    chartImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    coverImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    ...
    > &
      Schema.Attribute.Private;
    marketCap: Schema.Attribute.Decimal;
    marketCapChange: Schema.Attribute.Decimal;
    price: Schema.Attribute.Decimal;
    priceChange1h: Schema.Attribute.Decimal;
    priceChange24h: Schema.Attribute.Decimal;
    priceChange7d: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    symbol: Schema.Attribute.String;
    symbolPair: Schema.Attribute.String;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
